...
import br.edu.ifpb.ads.padroes.atv1.rpg.abstractFactory.oc.OrcGuerreiro;
...
public class OrcGuerreiroFM implements PersonagemFactory {
    @Override
    public Personagem criar(String nome) {
        var factory = new OrcGuerreiro();
